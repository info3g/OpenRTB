...
Following is an example of a bid response that returns the VAST
document inline to be served.  A few notes about specific fields
in the example:

- The bid for this impression is a $3.00 CPM.
- Note that since there both a win notice URL and an inline VAST document, the adm attribute is used for the VAST ad markeup.
